...
line_labels = ['True','Erroneous','DEnKF','Observations']
...
fig.tight_layout()
plt.show() 
fig.savefig('time_series_denkf.pdf',bbox_inches='tight')
fig.savefig('time_series_denkf.eps',bbox_inches='tight')
fig.savefig('time_series_denkf.png',bbox_inches='tight',dpi=300)