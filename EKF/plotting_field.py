...
label = ['True','True','True','EKF','EKF','EKF','Error','Error','Error']


for i in range(9):
    cs = axs[i].contourf(T,X,field[i],120,cmap='coolwarm',vmin=vmin,vmax=vmax,zorder=-9)
...
fig.tight_layout()
plt.show() 
fig.savefig('field_plot_ekf.pdf',bbox_inches='tight')
fig.savefig('field_plot_ekf.eps',bbox_inches='tight')
fig.savefig('field_plot_ekf.png',bbox_inches='tight',dpi=300)
