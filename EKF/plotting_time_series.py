...
line_labels = ['True','Erroneous','EKF','Observations']
...
fig.tight_layout()
plt.show() 
fig.savefig('time_series_ekf.pdf',bbox_inches='tight')
fig.savefig('time_series_ekf.eps',bbox_inches='tight')
fig.savefig('time_series_ekf.png',bbox_inches='tight',dpi=300)