...
line_labels = ['True','Erroneous','EnKF','Observations']
...
fig.tight_layout()
plt.show() 
fig.savefig('time_series_enkf.pdf',bbox_inches='tight')
fig.savefig('time_series_enkf.eps',bbox_inches='tight')
fig.savefig('time_series_enkf.png',bbox_inches='tight',dpi=300)