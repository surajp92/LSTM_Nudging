...
line_labels = ['True','Erroneous','LSTM','Observations']
...
fig.tight_layout()
plt.show() 
fig.savefig('time_series_lstm_200.pdf',bbox_inches='tight')
fig.savefig('time_series_lstm_200.png',bbox_inches='tight',dpi=600)